...
win_chance = model.predict([[goals_scored, possession, attempts, on_target, off_target, free_kick, pass_acc, fouls, yellow_card, red_card, PSO]])[0][1]
print("Your team:"+name)
print("Odds:",float(win_chance * 100),"%","chance of winning")
